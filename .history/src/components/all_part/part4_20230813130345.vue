<template>
        <div class="transition duration-200 ease-in-out w-full max-w-1280 py-66 absolute flex flex-col h-auto md:h-1160 mt-p4_mt2 minw:mt-p4_mt1 items-center justify-center">
